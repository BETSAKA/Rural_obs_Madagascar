...
locations <- tibble(
  ...
  name = c("Antalaha", "Antsirabe", "Marovoay", "Tuléar", "Anstohihy-Sofia", 
           "Tsiroanomandidy-Bongo", "Farafangana", "Ambovombe", 
           "Alaotra-Ambatondrazak", "Manjakandriana", "Tuléar littoral", 
           "Fenerive Est", "Bekily", "Mahanoro", "Soaviandriana-Itasy", 
           "Menabe-Belo", "Fianarantsoa", "Tsivory", "Morondava", "Manandriana", 
           "Tanandava", "Ihosy", "Ambohimahasoa", "Manakara", "Taolagnaro", 
           "Menabe-Nord-Est"),
...
timeline_plot <- ggplot(obs_count, aes(x = year, y = fct_reorder(observatory_name, latitude), color = observatory_name)) +
